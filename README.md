...
This repository represents my **Dev Journey**, a structured portfolio of backend development projects and learning progression.  
It highlights my skills in building robust APIs with **Python and Django REST Framework**, designing and testing services with **GoLang**, and applying modern deployment practices including **Docker**, **CI/CD pipelines**, and **cloud infrastructure with Terraform and AWS**.
